...
namespace MyFirstWebApplication.Controllers
{
    ...
    public class WeatherForecastController : ControllerBase
    {
        ...
        [HttpPost("add-data")]
        public ActionResult<bool> Add([FromQuery] DateTime date,
        ...
        [HttpPut("update-data")]
        public ActionResult<bool> Update([FromQuery] DateTime date,
            [FromQuery] int temperatureC)
        {
        ...
        [HttpGet("get-data")]
        public ActionResult<List<WeatherForecast>> Get([FromQuery] DateTime from,
