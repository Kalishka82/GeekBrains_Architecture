...
{
	/// <summary>
	/// Объект на базе класса WheatherForecastHolder будет хранить список
	/// показателей по температуре
	/// </summary>
	public class WeatherForecastHolder
	{
		...
		/// <summary>
		/// Удалить показатели температуры за определенную дату
		/// </summary>
		/// <param name="date"></param>
		/// <returns></returns>
		...
		/// <summary>
		///	Получить показатели температуры за период от до
		/// </summary>
