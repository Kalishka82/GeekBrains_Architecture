...
namespace ClinicService.Services.Impl
{
	public class ConsultationRepository : IConsultationRepository
    {
        ...
        public int Update(Consultation item)
        {
            ...
            connection.Open();
            using SqliteCommand command =
                new SqliteCommand("UPDATE consultations SET ConsultationId=@ConsultationId, ClientId=@ClientId, PetId=@PetId, ConsultationDate=@ConsultationDate, Description=@Description WHERE ConsultationId=@ConsultationId", connection);
        ...
        public IList<Consultation> GetByClientId(int clientId)
        {
            List<Consultation> list = new List<Consultation>();
            using SqliteConnection connection = new SqliteConnection();
            connection.ConnectionString = connectionString;
        ...
        public IList<Consultation> GetByPetId(int petId)
        {
            List<Consultation> list = new List<Consultation>();
            using SqliteConnection connection = new SqliteConnection();
            connection.ConnectionString = connectionString;
            connection.Open();
            using SqliteCommand command =
                new SqliteCommand("SELECT * FROM consultations WHERE PetId=@PetId", connection);
